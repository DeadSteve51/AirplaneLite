...
cp "$workdir/Paperclip/assembly/target/paperclip-${mcver}.jar" "$basedir/launcher-airplanelite.jar"

echo ""
echo ""
echo ""
echo "Build success!"
echo "Copied final jar to $(cd "$basedir" && pwd -P)/launcher-airplanelite.jar"
) || exit 1
